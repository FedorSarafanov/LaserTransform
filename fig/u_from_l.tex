...
\pgfplotstableset{
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=L, y=U,] {../data/61a.tsv};
		\addlegendentry{$i_\text{r}=1$ мА}

		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,red] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=L, y=U,] {../data/61b.tsv};
		\addlegendentry{$i_\text{r}=2$ мА}

		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,magenta] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=L, y=U,] {../data/61v.tsv};
		\addlegendentry{$i_\text{r}=3$ мА}
