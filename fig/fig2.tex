...
\begin{document}
\pgfplotstableset{
	create on use/rrrr/.style={
	    create col/expr={
	    \thisrow{obr}^2/\thisrow{sig}^2
	    }
	},
	create on use/rr2/.style={
	    create col/expr={
	    \thisrow{rr}
	    }
	},
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=x, line width=0.6pt, mark size=1.1pt,solid,red] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=i, y=rr,] {../data/tab.tsv};
		\addlegendentry{Теория}

		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=i, y=rrrr,] {../data/tab.tsv};
