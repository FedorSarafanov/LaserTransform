...
\pgfplotstableset{
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=i, y=op,] {../data/tab.tsv};
		\addlegendentry{$P_\text{оп}$}


		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,magenta] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=i, y=sig,] {../data/tab.tsv};
		\addlegendentry{$P_\text{сиг}$}

		\addplot +[mark=*, line width=0.6pt, mark size=1.1pt,solid,red] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=i, y=obr,] {../data/tab.tsv};
		\addlegendentry{$P_\text{обр}$}
		    \end{axis}
		\end{tikzpicture}	
\end{document}